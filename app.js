const GAME_DATA = {
  "project-candybust": {
    ...
    description: " Block Pop Mania is a vibrant match-and-blast puzzle game where every tap counts. Match and pop colorful blocks, trigger powerful combos, and clear cleverly designed levels using strategic boosters. With hundreds of handcrafted stages, smooth 3D visuals, and rewarding gameplay loops, it strikes the perfect balance between relaxation and challenge. Easy to learn, hard to master, and fully offline-friendly, Block Pop Mania is built for casual players and puzzle pros alike. ",
